...
public abstract class Satellite extends JComponent
{
	 ...
	 * 
	 *            public
	 *            Satellite (double x, double y, double velocity_x, double velocity_y,
	 ...
	 *                
	 */
	public abstract void update_position( double dt );
	 ...
	 *  
	 */
	public abstract void update_velocity( Geometry_Vector acceleration, double dt );
	 ...
	 *
	 */
	public abstract void update_screen_coordinates(
													Geometry_Vector system_center, double system_radius,
	 ...
	 * @return our mass
	 */
	public abstract double get_mass();
	 ...
	 * @return our position
	 */
	public abstract Geometry_Vector get_position();
	 ...
	 * @return our velocity
	 */
	public abstract Geometry_Vector get_velocity();
